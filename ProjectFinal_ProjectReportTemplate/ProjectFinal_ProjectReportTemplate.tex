...
From the proposal swap, you will be asked to respond to a list of potential socially-responsible concerns with your project. You will receive an email from the TAs with another team's list of concerns from your initial project proposal. Please respond to each of them here with a paragraph. This could be to accept the criticism and suggest ways to attempt to mitigate the potential harms, to add a more nuanced understanding to explain the situation around the criticism, or to rebut the criticism if you think it is invalid.
